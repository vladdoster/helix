...
* Add diagnostic source to the diagnostics pickers ([#13758](https://github.com/helix-editor/helix/pull/13758))
...
- Recognize `.git` as XML ([#7152](https://github.com/helix-editor/helix/pull/7152))
...
- Remove backtick auto-pair in OCaml ([#8260](https://github.com/helix-editor/helix/pull/8260))
...
- WITH ([#4525](https://github.com/helix-editor/helix/pull/4525))
